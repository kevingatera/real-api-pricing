...
OPENCODE_GO_MODELS = (
    ...
    # 2026-09-25 补充：官网页新增/此前遗漏的模型（dev.opencode.ai/docs/go 模型表，读取于 2026-09-25）。
    ("mimo-v2.6-flash", 60, 0.0028, 0.14, 0.28, "官网单档；请求估算 30,100/75,200/150,400（5h/周/月）"),
    ("mimo-v2.6-pro", 15, 0.003625, 0.435, 0.87, "官网单档；请求估算 3,250/8,150/16,300（5h/周/月）"),
    ("grok-4.7", 15, 0.5, 2.0, 6.0, "≤200K 标价；>200K 价翻倍（$4/$12），保留在 research variants"),
    ("gpt-6-luna", 15, 0.01, 0.10, 0.50, "≤272K 标价；>272K 档（$0.20/$0.75）保留在 research variants"),
...
COMMAND_CODE_GOAT_MODELS = (
    ...
    # 2026-09-25 补充：官方 Monthly credits 表（Every model / New models）中新出现或此前遗漏的模型。
    # 促销额度按稳态值采用，促销窗口写进备注，避免快照夸大长期容量。
    ("deepseek-v4.1-flash", 40, 0.003, 0.15, 0.60,
     "官网三段价；官方写 $40（$60 促销至 2026-09-28），采用稳态 $40；请求 30,800/76,900/154,000"),
    ("mimo-v2.6-flash", 20, 0.0028, 0.14, 0.28, "官网三段价；New models 默认$20；请求 13,000/32,500/64,900"),
    ("mimo-v2.6-pro", 20, 0.0036, 0.435, 0.87, "官网三段价；New models 默认$20；请求 5,700/14,200/28,500"),
    ("grok-4.7", 20, 0.5, 2.0, 6.0, "官网三段价；官方写 $20（$35 促销至 2026-09-27），采用稳态 $20"),
    ("gpt-6-luna", 20, 0.01, 0.10, 0.50, "官网三段价；New models 默认$20"),
    ("step-5-preview", 20, 0.05, 1.00, 2.70, "官网三段价；New models 默认$20"),
    ("glm-5.3-flashx", 20, 0.075, 0.37, 1.25, "官网三段价；New models 默认$20"),
